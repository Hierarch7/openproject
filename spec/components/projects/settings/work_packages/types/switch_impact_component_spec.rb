...
RSpec.describe Projects::Settings::WorkPackages::Types::SwitchImpactComponent,
  ...
  let(:switch) { Projects::Types::Switch.new(project:, source: epic, target_id:) }
  ...
  context "with a target chosen" do
    ...
    it "states how many work packages move" do
      render_component

      expect(page).to have_text("1 work package will be re-typed")
    end
